...
#const PLAYER_CAPSULE_RADIUS_DEFAULT := 18.159 * PLAYER_SIZE_MULTIPLIER
#const PLAYER_CAPSULE_HEIGHT_DEFAULT := 11.6205 * PLAYER_SIZE_MULTIPLIER
...
const PLAYER_HALF_WIDTH_DEFAULT := 18.0 * PLAYER_SIZE_MULTIPLIER
