...
const POINTER_DOWN_POSITION_PULSE_RADIUS_START_INCHES := 0.04
var POINTER_DOWN_POSITION_PULSE_RADIUS_START_PIXELS := \
        POINTER_DOWN_POSITION_PULSE_RADIUS_START_INCHES * Utils.get_viewport_ppi()
const POINTER_DOWN_POSITION_PULSE_RADIUS_END_INCHES := 0.08
var POINTER_DOWN_POSITION_PULSE_RADIUS_END_PIXELS := \
        POINTER_DOWN_POSITION_PULSE_RADIUS_END_INCHES * Utils.get_viewport_ppi()
const POINTER_DOWN_POSITION_PULSE_PERIOD_SEC := 0.3
const POINTER_DOWN_POSITION_PULSE_OPACITY_START := 0.8
const POINTER_DOWN_POSITION_PULSE_OPACITY_END := 0.5
